...
<div id="mobile-header">
    ...
    <header>
        ...
        <div class="container m-0 p-0 " style="width: 100%;">
            <img src="{{asset('images/header-mobile.jpg')}}" loading="lazy" class="lazyload img-fluid m-0 p-0" style="width: 100%;" alt="">    
...
<header id="main-header" class="" style="font-family:'sukhumvit';">
    <img src="{{asset('images/background-h1.jpg')}}" loading="lazy" class="img-fluid" alt="">
    ...
    <div class="login-box">
        ...
        <div id="main-content">
            <div class="container" style="background-color:rgba(0, 0, 0, 0.9);">
                ...
                <section class="main-container">
                    ...
                    <div class="row ">
                        <div class="col-12 col-sm-4">
                            <img src="{{'images/step1.jpg'}}" loading="lazy" class="img-fluid" alt="" srcset="">
                        </div>
                        <div class="col-12 col-sm-4">
                            <img src="{{'images/step2.jpg'}}" loading="lazy" class="img-fluid" alt="" srcset="">
                        </div>
                        <div class="col-12 col-sm-4">
                            <img src="{{'images/step3.jpg'}}" loading="lazy" class="img-fluid" alt="" srcset="">
                        </div>
                    </div>
                </section>
                <img src="https://joker123club.com/images/bg/bkg_line.png" loading="lazy" class="img-fluid" alt="">
                <section class="main-container text-white">
                    <br>
                    <div class="row">
                        <div class="col-md-3 d-none d-sm-block">
                            <figure>
                                <img src="{{asset('images/slot-online.png')}}" loading="lazy" class="img-fluid "
                ...
                <section class="main-container text-white">
                    ...
                    <div class="row ">
                        <div class="col-12 col-sm-6">
                            <img src="{{'images/1s.jpg'}}" loading="lazy" class="img-fluid" alt="" srcset="">
                        </div>
                        <div class="col-12 col-sm-6">
                            <img src="{{'images/2s.jpg'}}" loading="lazy" class="img-fluid" alt="" srcset="">
                        </div>
                        <div class="col-12 col-sm-6">
                            <img src="{{'images/3s.jpg'}}" loading="lazy" class="img-fluid" alt="" srcset="">
                        </div>
                        <div class="col-12 col-sm-6">
                            <img src="{{'images/4s.jpg'}}" loading="lazy" class="img-fluid" alt="" srcset="">
                        </div>
                    </div>
                </section>
                <img src="https://joker123club.com/images/bg/bkg_line.png" loading="lazy" class="img-fluid" alt="">
                    ...
                    <div class="main-container">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-3">
                                <img src="https://ace333.biz/image/pro/ท้าให้ลอง.jpg " loading="lazy" class="img-fluid" alt="">
                            </div>
                            <!-- <div class="col-12 col-sm-3">
                ...
                <section class="text-center text-white">
                    <br>
                    <img src="{{asset('images/cov_jpg/ace333_head2.jpg')}}" loading="lazy" class="img-fluid" style="margin-bottom: 20px;"  alt="">
                    <br>
                    ...
                    <div class="row text-center" style="padding-bottom: 20px;">
                        <a class="col-4 col-sm-2 m-0 p-0" href="https://lin.ee/mFG6UjH" target="" alt="ace333">
                            <img src="{{asset('images/cov_jpg/1.jpg')}} " loading="lazy" class="img-fluid" alt="ace333">
                        </a>
                        <a class="col-4 col-sm-2 m-0 p-0" href="https://lin.ee/mFG6UjH" target="" alt="ace333">
                            <img src="{{asset('images/cov_jpg/2.jpg')}} " loading="lazy" class="img-fluid" alt="ace333">
                        </a>
                        <a class="col-4 col-sm-2 m-0 p-0" href="https://lin.ee/mFG6UjH" target="" alt="ace333">
                            <img src="{{asset('images/cov_jpg/3.jpg')}}" loading="lazy" class="img-fluid" alt="ace333">
                        </a>
                        <a class="col-4 col-sm-2 m-0 p-0" href="https://lin.ee/mFG6UjH" target="" alt="ace333">
                            <img src="{{asset('images/cov_jpg/4.jpg')}}" loading="lazy" class="img-fluid" alt="ace333">
                        </a>
                        <a class="col-4 col-sm-2 m-0 p-0" href="https://lin.ee/mFG6UjH" target="" alt="ace333">
                            <img src="{{asset('images/cov_jpg/5.jpg')}}" loading="lazy" class="img-fluid" alt="ace333">
                        </a>
                        <a class="col-4 col-sm-2 m-0 p-0" href="https://lin.ee/mFG6UjH" target="" alt="ace333">
                            <img src="{{asset('images/cov_jpg/6.jpg')}}" loading="lazy" class="img-fluid" alt="ace333">
                        </a>
                        <a class="col-4 col-sm-2 m-0 p-0" href="https://lin.ee/mFG6UjH" target="" alt="ace333">
                            <img src="{{asset('images/cov_jpg/7.jpg')}}" loading="lazy" class="img-fluid" alt="ace333">
                        </a>
                        <a class="col-4 col-sm-2 m-0 p-0" href="https://lin.ee/mFG6UjH" target="" alt="ace333">
                            <img src="{{asset('images/cov_jpg/8.jpg')}}" loading="lazy" class="img-fluid" alt="ace333">
                        </a>
                        <a class="col-4 col-sm-2 m-0 p-0" href="https://lin.ee/mFG6UjH" target="" alt="ace333">
                            <img src="{{asset('images/cov_jpg/9.jpg')}}" loading="lazy" class="img-fluid" alt="ace333">
                        </a>
                        <a class="col-4 col-sm-2 m-0 p-0" href="https://lin.ee/mFG6UjH" target="" alt="ace333">
                            <img src="{{asset('images/cov_jpg/10.jpg')}}" loading="lazy" class="img-fluid" alt="ace333">
                        </a>
                        <a class="col-4 col-sm-2 m-0 p-0" href="https://lin.ee/mFG6UjH" target="" alt="ace333">
                            <img src="{{asset('images/cov_jpg/11.jpg')}}" loading="lazy" class="img-fluid" alt="ace333">
                        </a>
                        <a class="col-4 col-sm-2 m-0 p-0" href="https://lin.ee/mFG6UjH" target="" alt="ace333">
                            <img src="{{asset('images/cov_jpg/12.jpg')}}" loading="lazy" class="img-fluid" alt="ace333">
                        </a>
                        <a class="col-4 col-sm-2 m-0 p-0" href="https://lin.ee/mFG6UjH" target="" alt="ace333">
                            <img src="{{asset('images/cov_jpg/13.jpg')}}"  loading="lazy" class="img-fluid" alt="ace333">
                        </a>
                        <a class="col-4 col-sm-2 m-0 p-0" href="https://lin.ee/mFG6UjH" target="" alt="ace333">
                            <img src="{{asset('images/cov_jpg/14.jpg')}}" loading="lazy" class="img-fluid" alt="ace333">
                        </a>
                        <a class="col-4 col-sm-2 m-0 p-0" href="https://lin.ee/mFG6UjH" target="" alt="ace333">
                            <img src="{{asset('images/cov_jpg/15.jpg')}}" loading="lazy" class="img-fluid" alt="ace333">
                        </a>
                        <a class="col-4 col-sm-2 m-0 p-0" href="https://lin.ee/mFG6UjH" target="" alt="ace333">
                            <img src="{{asset('images/cov_jpg/16.jpg')}}" loading="lazy" class="img-fluid" alt="ace333">
                        </a>
                        <a class="col-4 col-sm-2 m-0 p-0" href="https://lin.ee/mFG6UjH" target="" alt="ace333">
                            <img src="{{asset('images/cov_jpg/17.jpg')}}" loading="lazy" class="img-fluid" alt="ace333">
                        </a>
                        <a class="col-4 col-sm-2 m-0 p-0" href="https://lin.ee/mFG6UjH" target="" alt="ace333">
                            <img src="{{asset('images/cov_jpg/18.jpg')}}" loading="lazy" class="img-fluid" alt="ace333">
                        </a>
                        <a class="col-4 col-sm-2 m-0 p-0" href="https://lin.ee/mFG6UjH" target="" alt="ace333">
                            <img src="{{asset('images/cov_jpg/19.jpg')}}" loading="lazy" class="img-fluid" alt="ace333">
                        </a>
                        <a class="col-4 col-sm-2 m-0 p-0" href="https://lin.ee/mFG6UjH" target="" alt="ace333">
                            <img src="{{asset('images/cov_jpg/20.jpg')}}" loading="lazy" class="img-fluid" alt="ace333">
                        </a>
                        <a class="col-4 col-sm-2 m-0 p-0" href="https://lin.ee/mFG6UjH" target="" alt="ace333">
                            <img src="{{asset('images/cov_jpg/21.jpg')}}" loading="lazy" class="img-fluid" alt="ace333">
                        </a>
                        <a class="col-4 col-sm-2 m-0 p-0" href="https://lin.ee/mFG6UjH" target="" alt="ace333">
                            <img src="{{asset('images/cov_jpg/22.jpg')}}" loading="lazy" class="img-fluid" alt="ace333">
                        </a>
                        <a class="col-4 col-sm-2 m-0 p-0" href="https://lin.ee/mFG6UjH" target="" alt="ace333">
                            <img src="{{asset('images/cov_jpg/23.jpg')}}" loading="lazy" class="img-fluid" alt="ace333">
                        </a>
                        <a class="col-4 col-sm-2 m-0 p-0" href="https://lin.ee/mFG6UjH" target="" alt="ace333">
                            <img src="{{asset('images/cov_jpg/24.jpg')}}" loading="lazy" class="img-fluid" alt="ace333">
                        </a>
